...
gitups render   -f test/e2e/local-qemu-1-host-1-sno-hub --state-dir /tmp/gitups-local-qemu-1-host-1-sno-hub
gitups apply    -f test/e2e/local-qemu-1-host-1-sno-hub --state-dir /tmp/gitups-local-qemu-1-host-1-sno-hub --dry-run
gitups apply    -f test/e2e/local-qemu-1-host-1-sno-hub --state-dir /tmp/gitups-local-qemu-1-host-1-sno-hub --yes
gitups status   -f test/e2e/local-qemu-1-host-1-sno-hub --state-dir /tmp/gitups-local-qemu-1-host-1-sno-hub --diff
gitups destroy  -f test/e2e/local-qemu-1-host-1-sno-hub --state-dir /tmp/gitups-local-qemu-1-host-1-sno-hub --yes
```
